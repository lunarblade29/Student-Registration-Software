    ...
    if request.method == "POST":
        try:
            ...
            student_data = {
                ...
                "Demand Draft Amount": request.form.get("demand_draft_amount") if request.form.get(
                    "demand_draft_submitted") == "Yes" else None,
                "Draft No.": request.form.get("draft_no") if request.form.get(
                    "demand_draft_submitted") == "Yes" else None,
                ...
                "reason_degree_certificate": request.form.get("reason_degree_certificate"),
                "reason_provisional_degree": request.form.get("reason_provisional_degree"),
                "reason_incomplete_graduation": request.form.get("reason_incomplete_graduation"),
                "reason_category_certificate": request.form.get("reason_category_certificate"),
                "reason_pwd_enclosure": request.form.get("reason_pwd_enclosure"),
                "reason_cat_score_card": request.form.get("reason_cat_score_card"),
                "reason_guardians_declaration": request.form.get("reason_guardians_declaration"),
                "reason_medical_info_form": request.form.get("reason_medical_info_form"),
                "reason_personal_data_card": request.form.get("reason_personal_data_card"),
                "reason_campus_rules_declaration": request.form.get("reason_campus_rules_declaration"),
                "reason_anti_ragging_form": request.form.get("reason_anti_ragging_form"),
                "reason_bank_details_declaration": request.form.get("reason_bank_details_declaration"),
            }
            ...
            for paragraph in doc.paragraphs:
                ...
                if "{remarks}" in paragraph.text:
                    paragraph.text = paragraph.text.replace("{remarks}", student_data["reason_photos"] + " " +
            ...
            def handle_checkbox_placeholder(paragraph, placeholder_yes, placeholder_no, placeholder_na,
                                            student_data_value):
            ...
            for paragraph in doc.paragraphs:
                ...
                handle_checkbox_placeholder(paragraph, "{py}", "{pn}", "{na}",
                ...
                handle_checkbox_placeholder(paragraph, "{gy}", "{gn}", "{na}",
                ...
                handle_checkbox_placeholder(paragraph, "{psy}", "{psn}", "{psna}",
